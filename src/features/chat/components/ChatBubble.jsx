...
const ChatBubble = React.memo(
  ({ message, isSentByMe, onImagePress, onVideoPress, onMediaDownload }) => {
      ...
      >
        {message.text && (
          <Text
            style={[
              styles.bubbleText,
              isSentByMe ? styles.sentBubbleText : styles.receivedBubbleText,
            ]}
          >
        ...
        {message.file && (
          <TouchableOpacity
            onPress={() => openDocument(message.file.url, message.file.name)}
            style={styles.fileContainer}
          >
            <Ionicons
              name="document"
              size={30}
              color={getFileColor(message.file.name)}
            />
            ...
            {message.downloading ? (
              ...
              >
                ...
                <Text style={styles.fileName}>
                  {message.pendingMedia.name || "Descargar Archivo"}
                </Text>
              </TouchableOpacity>
            )}
          </View>
        ...
        <View style={styles.bubbleFooter}>
          <Text
            style={[
              styles.bubbleTime,
              isSentByMe ? styles.sentBubbleTime : styles.receivedBubbleTime,
            ]}
          >
          ...
          {isSentByMe && (
            <View style={styles.statusContainer}>
              ...
              {message.read && (
                <Ionicons name="checkmark-done" size={14} color="#337ab7" />
              )}
            </View>
          )}
        </View>
  ...
  (prevProps, nextProps) => {
    ...
    return (
      ...
      prevProps.message.pendingMedia?.downloading ===
        nextProps.message.pendingMedia?.downloading &&
